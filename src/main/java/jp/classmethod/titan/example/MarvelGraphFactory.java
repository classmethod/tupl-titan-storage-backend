...
/**
 * This class is a copy of MarvelGraphFactory in the DynamoDB Storage Backend for Titan.
 * I copied it instead of depending on it so that I do not have to depend on the AWS DynamoDB
 * SDK (it brings in joda versions that are not compatible with what Titan/Gremlin Server ships
 * with.
