...
/**
 * The Titan manager for the Classmethod Storage Backend for Titan. Tracks implemented
...
public class TuplStoreManager extends AbstractStoreManager implements OrderedKeyValueStoreManager {
    ...
    public static final ConfigOption<String> TUPL_PREFIX = new ConfigOption<String>(TUPL_NS,
            "prefix", "The file prefix to use for the database files that correspond to this graph.",
            ConfigOption.Type.MASKABLE, "tupldb");
